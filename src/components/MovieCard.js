...
const MovieCard=({movie})=>{
    ...
    return(
        <>
              <div className="w-[160px] sm:w-[200px] md:w-[240px] lg:w-[280px] inline-block cursor-pointer relative p-2 text-gray-400">
                <img
                ...
                <div className="absolute top-0 left-0 w-full h-full hover:bg-black/80 opacity-0 text-lime-300 hover:opacity-100">
                    ...
                    <p className="absolute top-4 left-4 text-lime-300" onClick={savedShow}>
