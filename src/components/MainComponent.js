...
const Main = () => {
  ...
  return (
    <>
    <div className='w-full h-[550px] text-gray-300'>
        <div className='w-full h-full'>
            ...
            <div>
                <div className='absolute w-full top-[20%] p-4 md:p-8'>
                    ...
                    <div className='my-4'>
                        <button className='border bg-green-600 text-white border-gray-300 py-2 px-5'>Play</button>
                        <button className='border text-white border-green-300 py-2 px-5 ml-4'>Watch Later</button>
                    </div>
